...
The API is implemented on isklad.com and is accessible via the Internet. Provides a set of methods for exchanging
storage card data, orders, shipping methods, payments, invoices, etc ...
...
- **Examples**
    ...
    - [Create a shipment/label](examples/orders-fulfilled-by-client.md) - if the fulfillment process is **managed by an external company, or client himself**
- **Integration manuals**
...
- **Method list Client -> EGON**
    ...
    - [SettlementList](method-list/client-to-egon/SettlementList.md)
    - [SettlementItems](method-list/client-to-egon/SettlementItems.md)
    - [SettlementItemDetail](method-list/client-to-egon/SettlementItemDetail.md)
...
- **Code lists**
    ...
    - [MyOrder claim status list](code-lists/myorder_claim_statuses.md)
    - [MyOrder claim item type list](code-lists/myorder_claim_item_types.md)
