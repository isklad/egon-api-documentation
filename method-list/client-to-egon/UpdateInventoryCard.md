...
| `shop_setting_id`         |           | (Integer) | [link](https://egon.isklad.com/klient/settings-shop-settings) |        default: 1         | Set-to-order setting ID. :warning: if omitted, the first shop setting (ID 1) is used (selects which shop's API permissions apply) |
