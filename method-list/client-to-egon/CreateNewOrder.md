...
| `order_type`                 |                  | (String)  |                      regular / external                      |     default: regular      | Order type (`regular` - if the whole fulfillment process is managed by EGON, `external` - if the fulfillment process is managed by an external company, or client himself)                                                                                                                         |
