...
| `external_branch_id`         |                  |   (String)    |                                                              |           empty           | ** Only if delivery_branch_id is not sent, pickup point ID from an external company (e.g., Packeta)                                                                                                                                                                                                |
...
|                              | `exp_value`      |   (String)    |                                                              |           empty           | Expression in shapes \[YYYY-MM-DD-, YYYY-MM, YYYY\]                                                                                                                                                                                                                                                |
