...
|           |                  | `coupon_bonus`             |        |    (Float)     | Amount of the coupon bonus                                                 |
|           |                  | `refund`                   |        |    (Float)     | Price of the claim refund                                                  |
|           |                  | `reverse_shipping_amount`  |        |    (Float)     | Price of the reverse shipping                                              |
...
|           |                  |                            | `id`   |   (Integer)    | Returned type ID [Type list](../../code-lists/myorder_claim_item_types.md) |
